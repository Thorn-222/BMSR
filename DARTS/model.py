...
class ChannelSELayer(nn.Module):
    ...
    def __init__(self, num_channels, reduction_ratio=16):
        ...
        :param reduction_ratio: By how much should the num_channels should be reduced, the default value 16 is suggested by the authors in SENet paper
        reduction_ratio: 用于减少通道数的因子，默认为 16，这是 SENet 论文中的推荐值。通过这个比例，num_channels 会被减少为 num_channels // reduction_ratio
        """
    ...
    def forward(self, input_tensor):
        """
        :param input_tensor: X, shape = (batch_size, num_channels, H, W)，H 和 W：输入图像的高度和宽度。
