...
def extract(nasbench,arch):
    ...
    return cifar10_train, cifar10_valid, cifar10_test, cifar100_train, cifar100_valid, cifar100_test, imagenet16_train, imagenet16_valid, imagenet16_test
...
if __name__ == '__main__':
    ...
    for archi in nasbench:
        ...
        np.save('data/nasbench201_dict_search.npy', nasbench201_dict)

    #exit(0)
    nasbench201_dict = np.load('data/nasbench201_dict_search.npy', allow_pickle=True).item()
